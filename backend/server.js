...
// const notificationRoutes = require('./routes/notificationRoutes'); // Optionnel: À décommenter quand tu lieras tes routes notifs !
...
// app.use('/api/notifications', notificationRoutes); // À décommenter quand tes routes de notifications seront prêtes !
